...
class VoiceWindowPositionRouterTest {
    @Test fun aggregate_detents_stay_on_vehicle_composite_path() {
        assertNull(VoiceWindowPositionRouter.resolve("车窗通风"))
        assertNull(VoiceWindowPositionRouter.resolve("车窗半开"))
        assertNull(VoiceWindowPositionRouter.resolve("前排车窗通风"))
        assertNull(VoiceWindowPositionRouter.resolve("后排车窗半开"))
    }
