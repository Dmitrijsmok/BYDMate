...
class FullMigrationChainTest {
    ...
    private val dbName = "migration-chain-5-19.db"
    ...
    /** Oldest exported schema (5) through current (19) on PRODUCTION migrations only —
     *  validates every step against the exported schema JSONs, like a v1.x-era user
     *  updating straight to today's build. */
    @Test
    fun `full chain 5 to 19 on production migrations`() {
